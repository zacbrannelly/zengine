...
template<typename T>
inline void ZEngine::Mesh::SetBuffer(ZEngine::VertexBuffer*& buffer, bgfx::VertexLayout& decl, std::vector<T>& originalData, const float* data, unsigned int numElements)
{
...
template<typename T>
inline void ZEngine::Mesh::SetBuffer(ZEngine::VertexBuffer*& buffer, bgfx::VertexLayout& decl, const std::vector<T>& data)
{
